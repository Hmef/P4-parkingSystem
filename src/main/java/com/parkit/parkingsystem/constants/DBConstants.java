...
public class DBConstants {
    ...
    public static final String GET_NBR_TICKET = "select count(*) as nbr_ticket from ticket t,parking p where p.parking_number = t.parking_number and t.VEHICLE_REG_NUMBER=? ";
}
